...
export const LightbulbIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 14.25h3m-3 0V12a3 3 0 013-3h.5a3 3 0 013 3v2.25M10.5 14.25a3 3 0 00-3 3v.75a3 3 0 003 3h3a3 3 0 003-3v-.75a3 3 0 00-3-3m-3-9V3.75A2.25 2.25 0 0112 1.5h.008A2.25 2.25 0 0114.25 3.75v1.5m-3 0h3" />
    </svg>
);
